...
if __name__ == '__main__':
	...
	parser.add_argument('-t', '--threshold', type=float, help=' Threshold above which the concentration has to be considered', default=0)
	parser.add_argument('-d', '--decayTime', type=float, help=' Reaction decay time', default=10)
	parser.add_argument('-r', '--tmpRctFileToLoad', help='Reaction file to load', default='')
	parser.add_argument('-s', '--tmpRctSUBFileToLoad', help='Reaction subfile to load', default='')
	...
	tmpRctFileToLoad = args.tmpRctFileToLoad
	tmpRctSUBFileToLoad = args.tmpRctSUBFileToLoad
	today = dt.date.today()
