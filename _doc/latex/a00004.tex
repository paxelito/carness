...
\item {\itshape Concentration locked}\+: 0 -\/$>$ Concentration of the species changes according to the reactions affecting it, 1 -\/$>$ The concentration of the species is locked (permeable species, the concentration of the species is assumed to be constant within the cell and in the environment) ~\newline
...
\item {\itshape Spontaneous Constant}\+: Spontaneous reaction constant ~\newline
...
\item {\itshape Complex creation substrate target}\+: Which substrate will be involved in complex creation, 1 or 2 ~\newline
...
\item {\itshape Probabilitity}\+: Probability to be selected when a species has to be inserted into the system ~\newline
